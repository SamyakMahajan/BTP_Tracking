...
for i in range(1,50):
    ...
    plt.title('Probability Distribution of Eccentricity for frame {}'.format(i))
    plt.xlabel('eccentricity')
    plt.ylabel('Density')
    plt.savefig('results/eccDistributions/Ecc_distribution_{}.png'.format(i), dpi=300)  # Saves the plot in the current working directory
    plt.clf()
